...
Diferencias entre esta implementacion y el [LightRAG original (HKUDS/LightRAG, EMNLP 2025)](https://arxiv.org/abs/2410.05779). Las divergencias 4+5, 6, 7, 2, 9 estan resueltas en codigo. **Quedan abiertas dos divergencias**: #8 (chunks via vector search directo, 9/10) y #10 (sin keywords por chunk en indexacion, 6/10). La validacion empirica sobre un benchmark donde el paper muestra ventaja esta pendiente ("Proximos pasos · P0") y depende de la decision sobre #8.
